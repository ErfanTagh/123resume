...
export type ResumesTabId = "resumes" | "job-matching" | "job-tracker" | "portfolio" | "business-card";
...
/**
 * Minimal text tabs: muted by default, light hover, active = primary text only (no fill pill).
 */
